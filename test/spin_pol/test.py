...
def summarise_properties(mybands: BandData):
    ...
    print('Eigenvalues (spin 2) (eV)')
    print('k-point 1    ', mybands.eigenvalues[1, :, 0])
    print('k-point 2    ', mybands.eigenvalues[1, :, 1])
    print('k-point nk-1 ', mybands.eigenvalues[1, :, -2])
    print('k-point nk   ', mybands.eigenvalues[1, :, -1])
...
print('PP read')
bands = BandData('Si.bands.out', 'Si.up.dat', 'Si.down.dat', zero_fermi=False)
summarise_properties(bands)
print('')
